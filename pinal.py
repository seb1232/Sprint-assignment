...
def render_home():
    ...
    st.markdown("""
    <div class="apple-card" style='background-color: rgba(130, 133, 148, 0.7); padding: 30px; border-radius: 20px; margin: 40px 0 30px 0; backdrop-filter: blur(15px); animation: fadeInUp 0.8s ease-out;'>
