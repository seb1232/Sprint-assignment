        ...
        try:
            ...
            if missing_columns:
                ...
                with col1:
                    G
                    st.markdown(f"""
                    <div style='background-color:#f0f8ff; padding:15px; border-radius:10px; border:1px solid #d0e4f5;' class='metric-card'>
                    <h4 style='color:#004080;'>Total Tasks</h4>
                ...
                with col2:
                    st.markdown(f"""
                    <div style='background-color:#fff4e6; padding:15px; border-radius:10px; border:1px solid #ffd7b5;' class='metric-card'>
                        <h4 style='color:#b35900;'>Estimated Effort</h4>
                ...
                with col3:
                    ...
                    st.markdown(f"""
                    <div style='background-color:#e6f2ff; padding:15px; border-radius:10px; border:1px solid #b3daff;' class='metric-card'>
                        <h4 style='color:#005580;'>Priority Breakdown</h4>
                        {priority_html}
                    </div>
                    """, unsafe_allow_html=True)
